...
require (
	github.com/argoproj-labs/argocd-operator v0.0.16-0.20230126140958-2371eebbc80d
...
require (
	...
	github.com/argoproj/argo-cd/v2 v2.5.16 // indirect
	...
	github.com/keycloak/keycloak-operator v0.0.0-20220104081708-ab17327be9e1 // indirect
